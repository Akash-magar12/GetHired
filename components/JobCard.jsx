...
const JobCard = ({ job, isMiddle }) => {
  ...
  return (
    <Card className="bg-white/95 cursor-pointer backdrop-blur-sm border border-blue-200 hover:shadow-lg transition-all duration-300 h-full">
      <CardContent className="p-4 sm:p-5 md:p-6 h-full flex flex-col">
        ...
        {/* Position / Title */}
        <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 leading-tight">
          {title}
        </h4>
        ...
        {/* Description */}
        <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow line-clamp-3 sm:line-clamp-none">
          {description}
        </p>
