...
const ContactSection = () => {
  return (
    <section className="flex justify-center items-center py-16 ">
      <Card className="relative w-full  rounded-xl h-[70vh] flex flex-col justify-center items-center overflow-hidden border-0 bg-black text-white text-center shadow-lg">
