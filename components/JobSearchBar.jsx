...
const JobSearchBar = () => {
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center bg-white shadow-sm rounded-2xl sm:rounded-full p-3 sm:px-4 sm:py-2 w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl gap-2 sm:gap-0">
      ...
      <Button className="mt-2 sm:mt-0 sm:ml-3 px-4 sm:px-6 py-2 sm:py-1 bg-gradient-to-r text-white bg-black rounded-full cursor-pointer text-sm font-medium hover:opacity-90 transition w-full sm:w-auto">
        Search
      </Button>
    </div>
  );
